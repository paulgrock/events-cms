...
Koala.templates.add('confirm_modal', '<div class="modal-header"><button type="button" data-dismiss="modal" aria-hidden="true" class="close">x</button><h2><%= action %></h2></div><div class="modal-body"><div class="lead"><%= message %></div><p class="text-info">&quot;<%= snippet %>&quot;</p></div><div class="modal-footer"><button data-dismiss="modal" aria-hidden="true" class="btn cancel">Cancel</button><button class="btn btn-danger confirm">Confirm</button></div>');
...
Koala.templates.add('event_form', '<fieldset><legend>General</legend><div class="control-group"><label for="event_title" class="control-label">Title:</label><div class="controls"><input type="text" id="event_title" placeholder="Enter an Event Title..." value="<%= title %>" class="span3"/></div></div></fieldset><!--.control-group--><!--label.control-label(for=\'stream_select\') Stream:--><!--.controls#event-stream-wrapper--><!--.control-group--><!--label.control-label(for=\'group_select\') Group(s):--><!--.controls#event-group-wrapper--><fieldset><legend>Date and Time</legend><div id="startDate"></div><hr/><div id="endDate"></div></fieldset><fieldset><div id="matchup"></div></fieldset>');
...
Koala.templates.add('game_action_td_finished', '<i class="icon-ban-circle"></i>');
...
Koala.templates.add('game_tr', '<td><%= number %></td><td class="status"></td><td><%= starts_at %></td><td><%= ends_at %></td><td><%= winner %></td><td class="action"></td>');
...
Koala.templates.add('matchups_table', '<colgroup span="5"></colgroup><colgroup><col width="1"/></colgroup><thead><th>Status</th><th>Team A</th><th>Team B</th><th>Best Of</th><th>Played</th><th>Action</th></thead>');
Koala.templates.add('team_form', '<legend>Team</legend><div class="control-group"><label class="control-label">Team Name:</label><div class="controls"><input type="text" placeholder="Enter a team name..." value="<%= name %>" class="span3 teamName_input"/></div></div><div class="control-group"><label class="control-label">Team Logo:</label><div class="controls"><div class="team_image"></div><input type="text" placeholder="Enter an image URL..." value="<%= image_url %>" class="span3 teamLogo_input"/></div></div>');
